	...
	$.extend(
		{
			notifier:{
				...
				skins:{
					...
					box:"#_ #-{float:left;clear:both;padding:10px 0;color:#FFFFFF;position:relative;width:500px;margin-left: auto; margin-right:auto;margin-bottom:5px;}\n#_ #- .bg{z-index:-1;position:absolute;top:0;width:100%;height:100%;background:orange;opacity:.5;-moz-opacity:0.5;filter:alpha(opacity=50);}\n#_ #- h1, #_ #- p{clear:both;padding:0 10px;margin:0;font-size:24px;font-family:Arial;color:#FFFFFF;letter-spacing:0;}\n#_ #- p{font-size:16px;margin:5px 0}\n#_ #- p.time{font-size:10px;}\n#_ #- button{position:absolute;right:5px;top:5px;}",
					rounded:"#_ #- > div{border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;}\n",
					red:"#_ #-{color:#0000FF;}\n#_ #- .bg{background:#0000FF;}\n"
				},		
				notices:{},
